module.exports = ($) => {
	...
	let utils = {
		 ...
		 * @type {Array}
		 */
		blockElems: ['main', 'article', 'figure', 'figcaption', 'caption', 'cite', 'nav', 'dd', 'div', 'section', 'p', 'header', 'footer', 'aside', 'ul', 'ol', 'table', 'tr', 'li', 'blockquote', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'pre'],
		...
		escapeableMustHaves: {
			'-': (s) => s.replace(/(^\s*)(\\\-)/gm, '$1\-'),	// selects '\-' that are at the beginning of a line
